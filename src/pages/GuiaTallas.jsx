  ...
  return (
    <main className="pt-[70px] min-h-screen">
      ...
      <div className="max-w-2xl mx-auto px-8 py-12 font-sans text-[0.88rem] text-[#7A5A60] leading-relaxed">
        <img src="https://images.intimaexclusive.com/GUIA-TALLAS.png" alt="Guía de tallas" className="w-full border border-[#D9C4A8] mb-8"/>
        ...
        <img src="https://images.intimaexclusive.com/tabla.png" alt="Tabla de tallas" className="w-full border border-[#D9C4A8] mb-6"/>
